export const Mission = () => {
    return (
        <section className="container mx-auto px-5 md:px-20 lg:px-40 my-10 lg:my-20">
            <div className="rounded-2xl bg-indigo-500 text-white p-5 sm:p-10 relative overflow-hidden">
                ...
                <div className="absolute -top-16 sm:-top-8 right-1 text-9xl mb-3 text-indigo-400"><i className="fa-solid fa-braille"></i></div>
            </div>
        </section>
    )
}